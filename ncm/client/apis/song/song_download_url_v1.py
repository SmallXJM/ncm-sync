...
@ncm_api("/api/song/download/url/v1", ["GET", "POST"])
async def song_download_url_v1(
        id: Union[str, int],
        level: str = "standard",
        **kwargs
) -> APIResponse:
    ...
    return await request("/api/song/enhance/download/url/v1", data, _create_options(**kwargs))